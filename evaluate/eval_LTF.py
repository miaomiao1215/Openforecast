...
for line in lines:
    ...
    for question in info['LTF']:
        ...
        prompt_i = copy.deepcopy(prompt_1).format(background=background_str)
        # prompts_list.append(prompt_i)        if ('llama' in model_path or 'qwen' in model_path or 'Yi' in model_path):
