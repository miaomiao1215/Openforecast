...
for index in tqdm(range(0, len(question_list), batch_size)):
    ...
    for i, question in enumerate(question_list[index: index+batch_size]):
        ...
        assert len(rae_results) == len(gold_results)
